...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="containe-fluid p-0" >
              ...
              <div id="cf" class="d-md-block d-none"style="position:relative;margin:0 auto;display:none !important;height:127px">
            <img class="img-fluid w-100"src="https://www.zoopindia.com/assets/images/home/6m.jpg"alt="customised bulk food odering" style="animation-delay:20s;width:100% !important">
           ...
           <div id="cf" class="d-md-none" style="margin:0 auto;height:127px;">
            ...
            <img class="img-fluid w-100" src="https://www.zoopindia.com/assets/images/home/1.jpg"alt="order food in train"style="animation-delay:0s;position:absolute;animation-iteration-count:infinite;animation-duration:24s;left:0;width:100% !important">
             ...
             <section class="container-fluid searchTrain" style="background:#ffffff;text-align:center;padding:1rem 0 0;width:100%">
              ...
              <label class="form-check-label" for="inlineRadio1">PNR</label>
                ...
                <div class="col-md-6 offset-md-3 col-12 col-lg-offset-0 mt-md-3 mt-2">
                    <form class="customForm position-relative"style="position:relative!important">
                        <div class="form-floating-pnr input-group trainfield"style="position:relative;display:flex">
